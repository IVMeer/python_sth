...
df = pd.read_csv(r'E:\workspace\python_demo\Dec\Excel\0120-test.csv')

# 输入日期→命名输出文件夹称
# date = '2025/1/10至2025/1/11(唐山)'
date = '2025/1/17至2025/1/18(厦门)'
date_range = ['2025/1/17', '2025/1/18']
# 获取当天的日期并转化为字符串
...
filter_df['合并结果'] = (
    ...
    filter_df.iloc[:, 3].astype(str).str.zfill(2) + '-' +  # 摄像头编号（第四列）
